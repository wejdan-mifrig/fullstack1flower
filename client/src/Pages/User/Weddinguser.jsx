...
import heroVideo7 from "../../assets/video/vvv1.mp4";
...
const process = [
  {
    ...
    desc: "We listen to your vision and dream, defining the overall aesthetic and atmosphere",
  },
  {
    title: "Design Phase",
    desc: "We sketch colors, textures, and every detail that tells your unique story",
  },
  {
    title: "Execution",
    desc: "We transform the design into reality with meticulous attention to every detail",
  },
  {
    title: "Delivery",
    desc: "Your big day comes to life exactly as you imagined — and even more beautiful",
  },
];
...
const testimonials = [
  {
    name: "Reem K.",
    text: "Every detail was thoughtfully curated. She understood my vision better than I did.",
  },
  {
    name: "Lina A.",
    text: "The experience was elegant from our first meeting to the last moment of the wedding.",
  },
  {
    name: "Dana S.",
    text: "The decor exceeded every expectation. Truly professional, luxurious work.",
  },
];
...
const achievements = [
  {
    icon: <EmojiEventsRoundedIcon sx={{ fontSize: 48 }} />,
    title: "12+ Awards",
    desc: "International recognition for excellence in wedding design",
  },
  {
    icon: <DiamondRoundedIcon sx={{ fontSize: 48 }} />,
    title: "50+ Luxury Venues",
    desc: "Exclusive partnerships with the finest venues worldwide",
  },
  {
    icon: <StarRoundedIcon sx={{ fontSize: 48 }} />,
    title: "98% Satisfaction",
    desc: "Based on client feedback and post-wedding surveys",
  },
];
...
const certifications = [
  {
    ...
    org: "International Institute of Weddings",
    year: "2018",
  },
  { title: "Luxury Event Design", org: "Prestige Academy", year: "2019" },
  {
    title: "Floral Design Master",
    org: "European Floral Institute",
    year: "2020",
  },
];
...
export default function Weddinguser({ designer }) {
  const d = designer || {
    id: 1,
    name: "Sara",
    ...
    >
      <Container maxWidth="lg">
        <ScrollReveal>
          <SectionHeading
            eyebrow="MOTION"
            title="Her Moving Moments"
            icon={<PlayCircleOutlineRoundedIcon sx={{ color: COLORS.gold }} />}
          />
        </ScrollReveal>
              ...
              {videos.map((_, i) => (
                <Box
                  ...
                  sx={{
                    ...
                    borderRadius: 4,
                    bgcolor:
                      i === index ? COLORS.gold : "rgba(255,255,255,0.3)",
                    transition: "all .3s ease",
                    cursor: "pointer",
                    "&:hover": {
                      bgcolor:
                        i === index ? COLORS.gold : "rgba(255,255,255,0.5)",
                      transform: "scale(1.1)",
                    },
                  }}
                />
            ...
            <ScrollReveal key={i} delay={i * 0.08} y={20}>
              <Box
                sx={{
                  ...
                  "&:hover": {
                    borderColor: COLORS.gold,
                    boxShadow: "0 12px 40px rgba(201,161,90,0.15)",
                  },
    ...
    <Box
      sx={{
        ...
        "&::before": {
          ...
          bottom: 0,
          background:
            "radial-gradient(ellipse at 30% 50%, rgba(201,161,90,0.04) 0%, transparent 60%)",
  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        <Box
          ref={lineRef}
          sx={{ maxWidth: 980, mx: "auto", mt: 8, position: "relative" }}
        >
          <Box
            sx={{
            ...
            <ScrollReveal key={i} delay={i * 0.12}>
              ...
              >
                <FormatQuoteRoundedIcon
                  sx={{ color: COLORS.gold, fontSize: 36, mb: 1 }}
                />
                <Typography
                  sx={{
                    fontSize: "1.15rem",
    ...
    <Box
      sx={{
        ...
        "&::before": {
          ...
          bottom: 0,
          background:
            "radial-gradient(ellipse at center, rgba(201,161,90,0.03) 0%, transparent 70%)",
        },
      }}
    >
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
      ...
      <Container maxWidth="lg">
          ...
          <Box
            sx={{
              ...
              "&::after": {
                ...
                bottom: 0,
                background:
                  "linear-gradient(180deg, transparent 0%, rgba(62,74,58,0.3) 100%)",
                pointerEvents: "none",
              },
            }}
          >
        ...
        <ScrollReveal delay={0.2}>
          <Box sx={{ textAlign: "center", mt: 4 }}>
            ...
            >
              "Every love story deserves a beautiful beginning — let's write
              yours together."
            </Typography>
          </Box>
        </ScrollReveal>
                  ...
                  {TIME_SLOTS.map((t) => (
                    <Chip
                      ...
                      sx={{
                        ...
                        cursor: "pointer",
                        bgcolor:
                          time === t ? COLORS.gold : "rgba(62,74,58,0.06)",
                        color: time === t ? "#faf8f5" : COLORS.deepGreen,
                        transition: "all .2s ease",
                        fontWeight: time === t ? 700 : 400,
                        "&:hover": {
                          bgcolor:
                            time === t ? COLORS.gold : "rgba(62,74,58,0.1)",
                        },
                      }}
                    />
                  ))}
          ...
          <Grow in={submitted}>
            <Box sx={{ textAlign: "center", py: 6 }}>
              <CheckCircleRoundedIcon
                sx={{ fontSize: 56, color: COLORS.gold, mb: 2 }}
              />
              <Typography
                sx={{
                  fontSize: "1.6rem",
...
function SectionHeading({ eyebrow, title, icon }) {
  return (
    <Box sx={{ textAlign: "center" }}>
      ...
      <Box
        sx={{ width: 80, height: 2, bgcolor: COLORS.gold, mx: "auto", mt: 2 }}
      />
    </Box>
  );
}
