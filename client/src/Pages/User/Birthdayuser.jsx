...
// Image arrays - First 8 images for marquee
const marqueeImages = [bt1, bt2, bt3, bt4, bt5, bt6, bt7, bt8];

// Large images with text for second section - remaining 6 images
const largeImages = [
  { image: bt9, title: "Elegant Celebrations", desc: "Sophistication meets joy in our carefully curated birthday experiences. We blend timeless elegance with modern creativity to create celebrations that are both refined and full of life. Every detail is thoughtfully considered to ensure your special day is nothing short of extraordinary." },
  { image: bt10, title: "Personalized Touch", desc: "Every celebration is unique, just like the person being celebrated. We take the time to understand your vision and bring it to life with personalized details that make your event truly one-of-a-kind. Your story is our inspiration." },
  { image: bt11, title: "Festive Spirit", desc: "Bringing the energy and excitement of celebration to every detail. From vibrant decorations to lively entertainment, we create an atmosphere of pure joy and festivity that will leave your guests talking for years to come." },
  { image: bt12, title: "Love & Laughter", desc: "The two essential ingredients for any unforgettable celebration. We believe that the best events are filled with genuine connection and heartfelt moments that bring people together in meaningful ways." },
  { image: bt13, title: "Timeless Moments", desc: "Creating memories that will be cherished for generations to come. Our designs are crafted to stand the test of time, ensuring that your celebration remains a treasured memory forever in the hearts of all who attend." },
  { image: bt14, title: "Creative Vision", desc: "Our creative team brings fresh ideas and innovative concepts to every celebration. We push boundaries and think outside the box to create truly unique and memorable experiences that reflect your personality." },
];
...
export default function Birthdayuser() {
  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      const isPast = (currentYear < currentYearNow) || (currentYear === currentYearNow && currentMonth < currentMonthNow) || (currentYear === currentYearNow && currentMonth === currentMonthNow && day < today);
      ...
      days.push(
        <Box
          ...
          sx={{
            ...
            color: isSelected ? colors.white : (isPast || isBooked) ? colors.muted : colors.deepOrange,
            border: isSelected ? 'none' : (isBooked ? '1px solid #e0d6cf' : '1px solid transparent'),
            ...
            '&:hover': {
              bgcolor: (!isPast && !isBooked && !isSelected) ? 'rgba(139,58,42,0.08)' : '',
  ...
  return (
    <Box sx={{ overflowX: "hidden", bgcolor: colors.cream }}>
      ...
      >
        ...
        >
          <Typography sx={{ color: colors.silver, letterSpacing: 8, fontFamily: 'sans-serif', fontSize: 14, mb: 1.5, fontWeight: 500 }}>
            {designer.role.toUpperCase()}
          </Typography>
          <Typography variant="h1" sx={{ fontSize: { xs: '2.8rem', md: '4.2rem' }, lineHeight: 1.05, mb: 2, color: colors.white }}>
            {designer.name}
          </Typography>
          <Typography sx={{ color: colors.white, fontSize: { xs: '1rem', md: '1.1rem' }, lineHeight: 1.8, fontFamily: 'sans-serif', fontWeight: 300, opacity: 0.85 }}>
            {designer.desc}
            <br />
            <br />
            ...
            gatherings to grand celebrations, every detail is carefully
            curated to create moments of pure joy and wonder.
          </Typography>
          <Box sx={{ mt: 2.5, display: 'flex', gap: 1.5, justifyContent: { xs: 'center', md: 'flex-start' }, flexWrap: 'wrap' }}>
            <Chip
              label="Birthday Expert"
              sx={{ color: colors.gold, borderColor: colors.gold, bgcolor: 'rgba(201,161,90,0.1)', fontFamily: 'sans-serif', fontWeight: 700, fontSize: '0.85rem' }}
            />
            <Chip
              label="15+ Awards"
              sx={{ color: colors.gold, borderColor: colors.gold, bgcolor: 'rgba(201,161,90,0.1)', fontFamily: 'sans-serif', fontWeight: 700, fontSize: '0.85rem' }}
      ...
      >
        <Container maxWidth="md">
          ...
          >
            ...
            >
              Salem believes that every birthday is a canvas waiting to be painted
              with joy. From the initial spark of an idea to the final toast,
              we craft experiences that resonate with the heart and soul of the
            ...
            {rotatingPhrases.map((_, i) => (
              <Box
                ...
                sx={{
                  ...
                  height: 8,
                  borderRadius: '50%',
                  bgcolor: i === currentPhraseIndex ? colors.deepOrange : 'rgba(139,58,42,0.15)',
        ...
        <Container maxWidth="md">
          ...
          >
            ...
            >
              ...
              weaves together elements of design, emotion, and surprise to create
              celebrations that are as unique as the individuals they honor.
            </Typography>
          </motion.div>
        </Container>
      </Box>
      ...
      >
        <Container maxWidth="xl">
          ...
          >
            ...
            <Divider sx={{ width: 60, mx: "auto", borderColor: colors.orange, borderWidth: 2, mb: 4 }} />
          </motion.div>
        </Container>
        ...
        <Container maxWidth="md" sx={{ textAlign: "center" }}>
          ...
          >
            ...
            >
              ...
              unique chapter in someone's life story. We believe in capturing the
              essence of the person being celebrated, weaving their personality,
              passions, and dreams into every detail of the event.
              <br />
              <br />
              Our approach combines creativity with meticulous planning, ensuring
              that every moment feels magical and every guest leaves with cherished
              memories.
            </Typography>
          </motion.div>
        </Container>
        ...
        <Container maxWidth="md" sx={{ textAlign: "center" }}>
          ...
          >
            ...
            >
              ...
              vision to life. From the initial consultation to the final farewell,
              we handle every aspect of your celebration with care and precision.
              <br />
              <br />
              We believe that the best celebrations are those that feel personal,
              authentic, and full of heart. Let us help you create a birthday
      ...
      >
        <Box sx={{ p: { xs: 3, md: 4 }, position: 'relative' }}>
          <IconButton onClick={closeBooking} sx={{ position: 'absolute', top: 12, right: 12, color: colors.muted }}>
            <CloseRoundedIcon />
          </IconButton>

          {!submitted ? (
            <>
              <Typography sx={{ fontSize: '1.8rem', mb: 0.5, color: colors.deepOrange, fontWeight: 600 }}>
                Book with {designer.name}
              </Typography>
              <Typography sx={{ color: colors.muted, fontFamily: 'sans-serif', fontSize: 13, mb: 3 }}>
              ...
              <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                <Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
                    <IconButton onClick={() => changeMonth(-1)} size="small">
                      <ArrowForwardRoundedIcon sx={{ transform: 'rotate(180deg)', color: colors.deepOrange }} />
                    </IconButton>
                    <Typography sx={{ fontFamily: 'sans-serif', fontWeight: 600, color: colors.deepOrange }}>
                      {new Date(currentYear, currentMonth).toLocaleString('default', { month: 'long', year: 'numeric' })}
                    </Typography>
                    <IconButton onClick={() => changeMonth(1)} size="small">
                      <ArrowForwardRoundedIcon sx={{ color: colors.deepOrange }} />
                    </IconButton>
                  </Box>
                  <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 0.5, justifyItems: 'center' }}>
                    {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((day) => (
                      <Typography key={day} sx={{ fontSize: '0.65rem', color: colors.muted, fontFamily: 'sans-serif', fontWeight: 600 }}>
                        {day}
                      </Typography>
                    ))}
                    {renderCalendar()}
                  ...
                  <Box sx={{ display: 'flex', gap: 2, mt: 2, justifyContent: 'center' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                      <Box sx={{ width: 12, height: 12, borderRadius: '50%', bgcolor: colors.deepOrange }} />
                      <Typography sx={{ fontSize: '0.65rem', color: colors.muted, fontFamily: 'sans-serif' }}>Selected</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                      <Box sx={{ width: 12, height: 12, borderRadius: '50%', border: '1px solid #e0d6cf', bgcolor: 'transparent' }} />
                      <Typography sx={{ fontSize: '0.65rem', color: colors.muted, fontFamily: 'sans-serif' }}>Booked</Typography>
                    </Box>
                  </Box>
                  {selectedDate && (
                    <Typography sx={{ textAlign: 'center', mt: 1, color: colors.deepOrange, fontWeight: 600, fontSize: '0.9rem' }}>
                      Selected: {selectedDate} {new Date(currentYear, currentMonth).toLocaleString('default', { month: 'long' })}
                    </Typography>
                  )}
                </Box>
                ...
                <TextField
                  ...
                  sx={{
                    '& .MuiInputBase-root': { color: colors.deepOrange, fontFamily: 'sans-serif' },
                    '& .MuiInputLabel-root': { color: colors.muted, fontFamily: 'sans-serif' },
                    '& .MuiOutlinedInput-notchedOutline': { borderColor: 'rgba(139,58,42,0.15)' },
                    '&:hover .MuiOutlinedInput-notchedOutline': { borderColor: colors.orange },
                    '& .Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: colors.deepOrange },
                  }}
                />

                <Box>
                  <Typography sx={{ color: colors.muted, fontFamily: 'sans-serif', fontSize: 13, mb: 1 }}>
                    Preferred Time
                  </Typography>
                    ...
                    {['10:00 AM', '12:00 PM', '2:00 PM', '4:00 PM', '6:00 PM'].map((t) => (
                      <Chip
                        ...
                        sx={{
                          fontFamily: 'sans-serif',
                          cursor: 'pointer',
                          bgcolor: time === t ? colors.deepOrange : 'rgba(139,58,42,0.06)',
                          color: time === t ? colors.white : colors.deepOrange,
                          transition: 'all .2s ease',
                          fontWeight: time === t ? 700 : 400,
                          '&:hover': { bgcolor: time === t ? colors.deepOrange : 'rgba(139,58,42,0.1)' },
                        }}
                      />
                    ))}
                  </Box>
            ...
            <Grow in={submitted}>
              <Box sx={{ textAlign: 'center', py: 6 }}>
                <CheckCircleRoundedIcon sx={{ fontSize: 56, color: colors.deepOrange, mb: 2 }} />
                <Typography sx={{ fontSize: '1.6rem', mb: 1, color: colors.deepOrange, fontWeight: 600 }}>
                  Request Sent ✓
                </Typography>
                <Typography sx={{ color: colors.muted, fontFamily: 'sans-serif', fontSize: 14 }}>
          ...
          >
            ...
            <Box
              sx={{
                ...
                right: 0,
                height: "35%",
                background: "linear-gradient(to top, rgba(42,26,18,0.2), transparent)",
              }}
            />
          </Box>
        ))}
          ...
          >
            ...
            <Box
              sx={{
                position: "absolute",
                inset: 0,
                background: "linear-gradient(to top, rgba(42,26,18,0.7) 0%, rgba(42,26,18,0.1) 60%)",
